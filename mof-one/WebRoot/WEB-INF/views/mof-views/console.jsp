...
<head>
<title>系统控制台</title>
<link rel="stylesheet" href="${ctx}/res/mof-skin/css/mof-sys.css?v=1.0.6">
...
<body style="overflow: hidden;">
	...
	<div class="mof-content">
		...
		<div class="mof-content-left">
				<div class="left-menu">
					<div class="left-menu-header">
						<span id="btnExtend" class="glyphicon glyphicon-option-vertical  left-menu-header-icon"   title="展开"></span><span  class="left-menu-header-name"></span>
					</div>
					<div>
					<ul id="leftMenu" >
					</ul>
		...
		<div class="mof-content-center" >
				<!-- 页面片段 -->
				<div id="view-fragment"  class="view-fragment">
				</div>
				<!-- 全页面嵌入 -->
				<div  class="view-ifram">
						<iframe id="ifram-console"  frameborder="0" src="" scrolling="auto" width="100%"></iframe>
				</div>
		</div>
	</div>
	<!-- 	页脚 -->
	...
	<script type="text/javascript" src="${ctx}/res/mof-skin/js/mof-console.js?v=1.0.4"></script>
	<script type="text/javascript">
